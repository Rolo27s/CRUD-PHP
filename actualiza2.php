...
$seleccionar = "SELECT * FROM productos WHERE identificador = '$productoActualizar'";
            ...
            <div class="row mt-3 justify-content-md-center">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <form action="actualiza3.php?idmodifica=<?php echo $productoActualizar; ?>&nombreimagen=<?php echo $registro[4]; ?>" class="p-4" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" pattern="\d+(\.\d{1,2})?" class="form-control" name="precio" id="precio" title="Enter a valid decimal number (up to two decimal places)" value="<?php echo $registro[3] ?>" required />
                            </div>
                            <div class="mb-3">
